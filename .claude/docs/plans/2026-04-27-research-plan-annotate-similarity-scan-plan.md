...
### Phase 2: クリーンアップ
- [x] 2-1: `skills/research-plan-annotate-workspace/` を削除する
- [x] 2-2: `skills/research-plan-annotate/evals/` を削除する

### Phase 3: Git作業
- [x] 3-1: `feat/research-plan-annotate-similarity-scan` ブランチを作成する
- [x] 3-2: GitHub Issue #23 を作成する
- [x] 3-3: `SKILL.md`・`research.md`・`plan.md` を git add してコミットする（0399288）
- [x] 3-4: リモートにプッシュし、Issue #23 を紐付けたPR #24 を作成する

### Phase 4: 検証
- [x] 4-1: `bash tests/test_install.sh` を実行して全テスト通過を確認する（18/18 passed）
